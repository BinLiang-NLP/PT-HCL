...
class Instructor:
    ...
    def run_test(self):
        ...
        w_path = './zeroshot_vast/'+self.opt.method+'_vast_train.raw'
        w_fp = open(w_path, 'w')
        n_cross = 0
        n_not = 0
        # switch model to evaluation mode
        ...
        with torch.no_grad():
            for mt_batch, st_batch, o_batch in zip(mask_data_loader, sentence_data_loader, orig_data_loader):
                ...
                for mp, sp, mt, text, target, stance, mask_text in zip(m_predict, s_predict, mt_targets, orig_texts, orig_targets, orig_stances, st_texts):
...
def main():
	...
	'dt': {
            ...
            'sentence': './augment_data/sentence/dt.raw',
        },
        'hc': {
            ...
            'replace': './augment_data/replace/hc.raw',
             'sentence': './augment_data/sentence/hc.raw',
      },
        'fm': {
            ...
            'replace': './augment_data/replace/fm.raw',
             'sentence': './augment_data/sentence/fm.raw',
      },
        'la': {
            ...
            'replace': './augment_data/replace/la.raw',
             'sentence': './augment_data/sentence/la.raw',
      },
        'tp': {
            ...
            'replace': './augment_data/replace/tp.raw',
             'sentence': './augment_data/sentence/tp.raw',
      },
        'cvs_aet': {
            ...
            'replace': './augment_data/replace/cvs_aet.raw',
             'sentence': './augment_data/sentence/cvs_aet.raw',
     },
        'ci_esrx': {
            ...
            'replace': './augment_data/replace/ci_esrx.raw',
             'sentence': './augment_data/sentence/ci_esrx.raw',
      },
        'antm_ci': {
            ...
            'replace': './augment_data/replace/antm_ci.raw',
             'sentence': './augment_data/sentence/antm_ci.raw',
      },
        'aet_hum': {
            ...
            'replace': './augment_data/replace/aet_hum.raw',
             'sentence': './augment_data/sentence/aet_hum.raw',
      },
        'vast': {
    ...
    if opt.is_test:
        ...
        for aug_method in ['lda']:
            #opt.state_dict_path='state_dict/bert_spc_vast_val_acc_0.8678'#put model trained from istest=0 here
