    ...
    def _train(self, criterion, con_criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            for i_batch, batch in enumerate(train_data_loader):
                ...
                cross_loss,_,_ = con_criterion(logits, cross_labels, targets)
            ...
            if val_f1_avg > max_val_f1_avg:#sem16
                ...
                path = 'state_dict_cl/{0}_{1}_val_f1_avg{2}'.format(self.opt.model_name, self.opt.dataset, round(val_f1_avg, 4))
...
def main(ds,method):
    ...
    opt.newname='aug_'+opt.method
    ins = Instructor(opt)
    now_f1_pro,now_f1_con,now_f1_avg=ins.run()

       
    f_max.write('test_f1_pro: {:.4f}, test_f1_con: {:.4f}, test_f1_avg: {:.4f}'.format( now_f1_pro,now_f1_con,now_f1_avg)+'\n')
    f_max.close()
