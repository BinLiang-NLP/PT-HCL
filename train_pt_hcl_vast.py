...
from models import BERT_PT_HCL
...
class Instructor:
    ...
    def _train(self, sup_criterion, pretext_criterion, stance_criterion, optimizer, train_data_loader, val_data_loader):
        max_val_acc = 0
        max_val_f1 = 0
        max_val_epoch = 0
        global_step = 0
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            n_correct, n_total, loss_total, sub_loss1, sub_loss2 = 0, 0, 0, 0, 0
            ...
            for i_batch, batch in enumerate(train_data_loader):
                ...
                sub_loss2 += contrastive_loss * len(outputs)
    ...
    def run(self):
        ...
        self._reset_params()
        best_model_path = self._train(sup_criterion, pretext_criterion, stance_criterion, optimizer, train_data_loader, val_data_loader)
...
def main():
    ...
    parser.add_argument('--model_name', default='bert_pt_hcl', type=str)
